...
class AppState:
    ...
    def __init__(self):
        ...
        # Req-Func-Sw-4: admin-configurable health score threshold
        self.health_score_threshold: float = float(
            os.environ.get("HEALTH_SCORE_THRESHOLD", "70")
        )

        # LSTM accuracy metrics (populated by ml/scripts/evaluate.py)
        self.lstm_accuracy: dict = {}
